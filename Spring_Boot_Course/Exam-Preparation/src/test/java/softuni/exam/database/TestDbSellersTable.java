...
@DataJpaTest
public class TestDbSellersTable {
    ...
    @Test
    void testSellersTable() throws SQLException {
        ...
        expectedResult.add("PERSONAL_NUMBER,CHARACTER VARYING,0,null,255");

        ResultSet columns = metaData.getColumns(null, "PUBLIC", "SELLERS", null);
