...
public class TestDbPrimaryKeys {
    ...
    void testPrimaryKeys() throws SQLException {
        ...
        ResultSet primaryKeyMountaineers = metaData.getPrimaryKeys(null, null, "MOUNTAINEERS");
        ResultSet primaryKeyCountries = metaData.getPrimaryKeys(null, null, "COUNTRIES");
        ResultSet primaryKeyMountains = metaData.getPrimaryKeys(null, null, "MOUNTAINS");

        List<String> actualResult = new ArrayList<>();

        primaryKeyMountaineers.next();
        actualResult.add(primaryKeyMountaineers.getString("TABLE_NAME"));
        actualResult.add(primaryKeyMountaineers.getString("COLUMN_NAME"));
        ...
        primaryKeyMountains.next();
        actualResult.add(primaryKeyMountains.getString("TABLE_NAME"));
        actualResult.add(primaryKeyMountains.getString("COLUMN_NAME"));
