...
@DataJpaTest
public class TestDbMountaineersTable {
    ...
    @Test
    void testMountaineersTable() throws SQLException {
        DatabaseMetaData metaData = getDatabaseMetaData();
        List<String> expectedResult = new ArrayList<>();
        expectedResult.add("ID,BIGINT,0,null,64");
        expectedResult.add("AGE,INTEGER,0,null,32");
        expectedResult.add("MOUNTAINEER_FROM,DATE,1,null,10");
        expectedResult.add("FIRST_NAME,CHARACTER VARYING,0,null,255");
        expectedResult.add("LAST_NAME,CHARACTER VARYING,0,null,255");
        expectedResult.add("BUDGET,DOUBLE PRECISION,0,null,53");
        expectedResult.add("CLIMBING_MOUNTAIN_ID,BIGINT,1,null,64");


        ResultSet columns = metaData.getColumns(null, "PUBLIC", "MOUNTAINEERS", null);
