...
@DataJpaTest
public class TestDbCountriesTable {
    ...
    void testCountriesTable() throws SQLException {
        ...
        expectedResult.add("CAPITAL,CHARACTER VARYING,1,null,255");
        expectedResult.add("NAME,CHARACTER VARYING,0,null,255");

        ResultSet columns = metaData.getColumns(null, "PUBLIC", "COUNTRIES", null);
